...
<div class="warp">
    <div class="innerOut">
        ...
        <form method="post" action="update.pl" enctype="multipart/form-data">   
            ...
            <div class="text">
            <div class="text-area">
            제목 : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="ptitle" id="ptitle" value="${ p.ptitle }"  style="width: 530px;"> <br>
            작성자 : &nbsp;&nbsp;&nbsp;<input type="text" name="pwriter" id="pwriter" value="user01" style="border: none; "> <br>
            상세주소 : <input type="text" name="paddress" id="paddress" value="${ p.paddress }" style="width: 530px;"> <br><br>
            한줄평 : &nbsp;&nbsp;&nbsp;<input type="text" name="plocation" id="plocation" value="${ p.plocation }" style="width: 530px;"> <br><br>
    ...
    <div class="photo" style="width: 100%;">
        <div class="photo-area">
            <img src="${ p.pimg1 }" alt="사진 1" id="titleImg" onclick="chooseFile(1);" width="150" height="120">
            <img src="${ p.pimg2 }" alt="사진 2" id="contentImg1" onclick="chooseFile(2);" width="150" height="120">
            <img src="${ p.pimg3 }" alt="사진 3" id="contentImg2" onclick="chooseFile(3);" width="150" height="120">
            <img src="${ p.pimg4 }" alt="사진 4" id="contentImg3" onclick="chooseFile(4);" width="150" height="120">
