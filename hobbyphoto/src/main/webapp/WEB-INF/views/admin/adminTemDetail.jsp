...
<jsp:include page="adminAlert.jsp"/>
	...
	<div class="container">
        <h2>상세 보기</h2>
            ...
            <input type="text" id="productName" name="temName" value="${ t.temName }" readonly>
            ...
            <input type="number" id="productPrice" name="price" value="${ t.price }" readonly> <br>
            ...
            <img src="${ t.titleImg }" alt="" width="80px" height="80px"> <br>

            <label for="productDescription">상품 개요 :</label> <br>
            <img src="${ t.temImg }" alt="pdimg Preview" width="80px" height="80px"> <br>
