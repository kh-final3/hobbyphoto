...
<body>
	<div id="write">
		...
		<form action="insertExhibit.fs" method="post"
			...
			<br>
			<div id="write2">
				<label id="ff4">제목</label><br> <input type="text"
					name="feTitle" style="width: 650px; margin: 5px 0 0 0;"
			...
			<br>
			<div id="write4">
				<label id="ff4">전시/축제</label><br> <input type="text"
					name="feType" style="width: 650px; margin: 5px 0 0 0;"
			...
			<div id="write5">
				<hr>
				<span id="ff4">📍 장소</span> <br> <input type="text"
					name="feLocation" style="width: 650px; margin: 5px 0 0 0;"
			...
			<div id="write10">
				<span id="ff4">관람료</span> <br> <input type="text" name="cash"
					style="width: 650px; margin: 5px 0 0 0;"
					placeholder="ex) 10,000원, 무료등.." required>
				<hr>
			</div>
			<br>
			<div id="write11">
