...
<head>
    ...
    <style>
        ...
        .exhibitionDetail-collectionBox {
            ...
            background: #fff url(/static/pages/img/service/detailview/lined_heart_sprite.png) 3px 3px no-repeat;
        ...
        .exhibitionDetail-shareButton {
            ...
            height: 48px;
            border-left: 1px solid #eee;
            background: #fff url(/static/pages/img/service/detailview/share_icon.png) 3px 3px no-repeat;
    ...
    <div id="wrap" class="header_banner_padding">
        ...
        <div id="contents">
            <div class="exhibitionDetail">
                ...
                <section class="exhibitionDetail-carousel owl-carousel owl-loaded owl-drag">
                ...
                <section class="exhibitionDetail-section">
                    ...
                    <div class="exhibitionDetail-infoTable">
                        <div class="exhibitionDetail-infoTable-head cf">
                            ...
                            <div class="exhibitionDetail-shareButton" data-pathname="/exhibition/4189/"
                        ...
                        <table class="exhibitionDetail-infoTable-table">
                            <tbody>
                                <tr>
                                    <th>작가</th>
                                    <td class="exhibitionDetail-infoTable-artists">
                                        키스 해링,
                                        뱅크시
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="exhibitionDetail-infoTable-contact">
                                        02-3789-2205
                                        <div class="exhibitionDetail-infoTable-contactSub exhibitionDetail-sm">
